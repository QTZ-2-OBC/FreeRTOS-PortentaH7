...
// NOTE: According to MaxCarrier docs, the GPIO_PIN_38 is used for DE when using
// RS-485. This translates to the PI10 on the Portenta H7
#define QTZ_RS485_DE_Pin GPIO_PIN_10
#define QTZ_RS485_DE_BASE GPIOI

// NOTE: According to MaxCarriers docs:
// https://docs.arduino.cc/tutorials/portenta-max-carrier/user-manual/#using-arduino-ide-7
...
typedef enum {
  QTZ_RECEIVERS485_OK,
  QTZ_RECEIVERS485_Timeout,
  QTZ_RECEIVERS485_Busy,
