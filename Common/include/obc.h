...
typedef enum {
  QTZ_OBC_PROTOCOL_HANDOVER = 0,
  QTZ_OBC_PROTOCOL_SUBSYSTEMS,
} QTZ_OBC_Protocol;

typedef enum {
  QTZ_OBC_SUBSYSTEM_GOMSPACE = 0,
  QTZ_OBC_SUBSYSTEM_PORTENTA,
  QTZ_OBC_SUBSYSTEM_MILO,
  QTZ_OBC_SUBSYSTEM_ADCS,
} QTZ_OBC_Subsystem;
